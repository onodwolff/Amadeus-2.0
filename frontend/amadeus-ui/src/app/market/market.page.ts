...
export class MarketPage implements OnInit {
  ...
  private readonly fallbackTimeframeOption = this.timeframeOptions[0] ?? {
    value: '1m',
    label: '1m',
  };
  readonly selectedTimeframe = signal(
    (this.timeframeOptions[3] ?? this.fallbackTimeframeOption).value,
  );
